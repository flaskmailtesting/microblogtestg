...
from megatutApp import create_app
from megatutApp.models import Task
from megatutApp.email import send_email
...
def export_posts(user_id):
	try:
		...
		send_email("[Microblog] Your blog posts",
			...
			html_body=render_template("email/export.posts.html", user=user),
